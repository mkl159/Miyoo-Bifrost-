...
CONFIG_TEXTS = {
    "FR": {
        ...
        "entry_btns":     "Boutons valides :  Haut  Bas  Gauche  Droite  X  Y  L  R  START",
    ...
    "EN": {
        ...
        "entry_btns":     "Valid buttons :  Up  Down  Left  Right  X  Y  L  R  START",
    ...
    "ES": {
        ...
        "entry_btns":     "Botones validos :  Arriba  Abajo  Izq  Der  X  Y  L  R  START",
